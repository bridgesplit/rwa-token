...
import { getSetupAssetControllerIxs, getSetupIssueTokensIxs, getTransferTokensIx, getSetupUserIxs, getAttachIdentityApprovalIx } from '../src/utils';
...
test.serial('setup registries', async (t) => {
    ...
    const setupAssetController = await getSetupAssetControllerIxs(setup.payer.toString(), setup.authority.toString(), setup.delegate.toString(), createAssetControllerArgs)

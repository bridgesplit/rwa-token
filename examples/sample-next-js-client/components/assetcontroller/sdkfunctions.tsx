...
export function handleMessage(ix: { message: string; inputValues: AssetControllerArgs }, rwaClient: RwaClient): void {
    switch (ix.message) {
        case 'SetupAssetController':
            handleSetupAssetController(ix.inputValues as SetupAssetControllerArgs, rwaClient);
            break;
        case 'IssueTokens':
...
async function handleIssueTokens(inputValues: IssueTokenArgs, rwaClient: RwaClient): Promise<void> {
...
async function handleVoidTokens(inputValues: VoidTokensArgs, rwaClient: RwaClient): Promise<void> {
...
async function handleTransferToken(inputValues: TransferTokensArgs, rwaClient: RwaClient): Promise<void> {
    // TODO: Complete last
}
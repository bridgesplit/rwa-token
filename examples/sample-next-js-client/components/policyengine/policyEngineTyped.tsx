...
export const PolicyEngine = () => {
    ...
    return (
        <div className='w-[700px]'>
            ...
            <div className='py-4'>
                <button type="submit" onClick={() => handleSubmit(policyArgs)} className="w-full cursor-pointer py-2 px-4 bg-[#ff7051] text-white font-semibold rounded-md hover:bg-[#c9a272] border-4 border-black">SUBMIT INSTRUCTIONS</button>
            </div>
        </div >
    );
};

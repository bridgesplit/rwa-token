...
export const importKeyBackend = async (
  keyData: string,
  keyUsage: KeyUsage[]
...
export const sendV0SolanaTransaction = async (
  wallet: AnchorWallet,
...
export const confirmSignatureStatus = async (
  ...
  while (!hashExpired && !txSuccess) {
    ...
    if (
      ...
      txSuccess = true;
      console.log(
        `Transaction Success. View on explorer: https://solscan.io/tx/${signature}`
      );
      break;
    }
    ...
    if (status?.err !== null && status?.err !== undefined) {
      console.log(
        `Transaction failed. View on explorer: https://solscan.io/tx/${signature}`
      );
      return false;
    }
...
export const isBlockhashExpired = async (
  connection: Connection,
